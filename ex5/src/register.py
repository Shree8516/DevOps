...
Pushes the trained regression model along with a model card
containing the evaluation metrics to Hugging Face Hub.

Runs only from CI, only on main,
and only after the evaluation stage passes the quality gate.
"""
